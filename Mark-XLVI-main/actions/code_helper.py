...
def _get_gemini(model: str = LOCAL_MODEL):
            ...
            if isinstance(contents, list):
                ...
                for part in contents:
                    if isinstance(part, str):
                        ...
                        text_parts.append("[non-text input omitted: local text model]")
                contents = "\n\n".join(text_parts)
            text = call_llm_text(str(contents), model=model)
            return type("LocalLLMResponse", (), {"text": text})()
